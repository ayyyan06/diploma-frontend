    ...
    <main className="mx-[110px] mb-[150px] mt-[74px] max-[1280px]:mx-8 max-[768px]:mx-4">
      ...
      >
        <div className="max-w-[620px]">
          ...
          <p className="mb-[26px] text-[16px] font-normal leading-[24px] text-[#555555] max-[768px]:mb-6">
            {description}
          </p>

          <p className="mb-[40px] max-w-[560px] text-[15px] leading-[1.6] text-[#6f6a60]">
            This test does not diagnose personality. It explores how you
            typically respond to uncertainty, pressure, and changing conditions
            inside one connected story.
          </p>
